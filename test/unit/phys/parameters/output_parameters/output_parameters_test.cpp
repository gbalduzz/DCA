...
TEST(OutputParametersTest, DefaultValues) {
  ...
  EXPECT_EQ("", pars.get_config_read_file());
  EXPECT_EQ("", pars.get_config_write_file());
...
TEST(OutputParametersTest, ReadAll) {
  ...
  EXPECT_EQ("configuration", pars.get_config_read_file());
  EXPECT_EQ("configuration", pars.get_config_write_file());
